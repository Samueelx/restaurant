        ...
        <div class="container">
            <div class="menu">
                ...
                <div class="menu-group">
                    ...
                    <div class="menu-item">
                        <img src="./resources/images/rice-with-beef.jpg" alt="rice-with-beef" class="menu-item-image">
                        <div class="menu-item-text">
                            <h3 class="menu-item-heading">
                                <span class="menu-item-name">Rice with beef</span>
                                <span class="menu-item-price">KES 500</span>
                            </h3>
                            <p class="menu-item-description">
                                Beef fried rice is probably one of my favorite dishes on a standard Chinese takeout menu.
                            </p>
                        </div>
                    </div>
                    <div class="menu-item">
                    ...
                    <div class="menu-item">
                        <img src="./resources/images/ramen.jpg" alt="Ramen" class="menu-item-image">
                        <div class="menu-item-text">
                            <h3 class="menu-item-heading">
                                <span class="menu-item-name">Ramen</span>
