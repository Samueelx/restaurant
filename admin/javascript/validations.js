...
form.addEventListener('submit', (e) => {
    ...
    isLastnameValid = checkLname(), isEmailValid = checkEmail(), isPasswordValid = checkPassword();

    let validForm = isUsernameValid && isFirstnameValid && isLastnameValid && isEmailValid && isPasswordValid;
...
const showError = (input, message) => {
    const formField = input.parentElemet;
